package org.gelecekbilimde.ui.dialogs
...
class AppInfoDialog(var context: Context, var activity: Activity) {
    ...
    private companion object{
        val GITHUB_URL = "https://github.com/gelecekbilimde"
        val TEYIHAN_PROFILE = "https://www.linkedin.com/in/teyyihan-aksu-14b563173"
    ...
    fun createAppInfoDialog() {
        ...
        val teyihanCard: LinearLayout = (view.findViewById(R.id.teyihan_card)) as LinearLayout
        ...
        teyihanCard.setOnClickListener {
            UrlOpen(TEYIHAN_PROFILE)
